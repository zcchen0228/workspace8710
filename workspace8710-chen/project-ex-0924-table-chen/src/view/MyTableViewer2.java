...
import model.editing.GetEmailEditingSupport;
import model.editing.GetPhoneEditingSupport;
...
import model.labelprovider.GetEmail;
import model.labelprovider.GetPhone;
...
public class MyTableViewer2 {
   ...
   private void createViewer(Composite parent) {
      ...
      viewer.setInput(PersonModelProvider.INSTANCE.getPersons2());
   ...
   private void createColumns(final Composite parent, final TableViewer viewer) {
      ...
      col.setLabelProvider(new GetPhone());
      col.setEditingSupport(new GetPhoneEditingSupport(viewer));

      col = createTableViewerColumn(titles[3], bounds[3], 3);
      col.setLabelProvider(new GetEmail());
      col.setEditingSupport(new GetEmailEditingSupport(viewer));
   }
