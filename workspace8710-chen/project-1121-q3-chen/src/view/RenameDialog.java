...
public class RenameDialog extends TitleAreaDialog {
   ...
   public boolean setMethodOrClass;

   public boolean isSetMethodOrClass() {
	return setMethodOrClass;
}

public void setSetMethodOrClass(boolean setMethodOrClass) {
	this.setMethodOrClass = setMethodOrClass;
}
...
public RenameDialog(Shell parentShell) {
   ...
   private void createNewClassName(Composite container) {
	      Label lbName = new Label(container, SWT.NONE);
	      lbName.setText("New Name");
	      ...
	      data.grabExcessHorizontalSpace = true;
	      data.horizontalAlignment = GridData.FILL;
	      txtNewClassName = new Text(container, SWT.BORDER);
	      txtNewClassName.setLayoutData(data);
	   }
   ...
   private void saveInputClass() {
	      newClassName = txtNewClassName.getText();
	   }
