...
public class Viewer {
   ...
   private void createContextMenu(Composite parent) {
      ...
      createMenuItem2(contextMenu, sb.toString());
   }
   ...
   private void createMenuItem2(Menu contextMenu, String inputStr) {
	   final MenuItem menuItem2 = new MenuItem(contextMenu, SWT.PUSH);
	      ...
	      menuItem2.addSelectionListener(new SelectionAdapter() {
	    	  public void widgetSelected(SelectionEvent e) {
	    		  ...
	    		  strList.add("Package name,Class name,Method Name,isReturnVoid,Parameter size,Start Position");
	    		  
	    		  for (ProgramElement p : elements) {
	    		  ...
	    		  try {
						UtilFile.saveFile("output.csv", strList);
   ...
   private void createProgElemColumns(final Composite parent, final TableViewer viewer) {
      ...
      col.setLabelProvider(new ColumnLabelProvider() {
         ...
         public String getText(Object element) {
            ...
            String str = "";
//            if (p.isReturnVoid()) {
//            	str = p.getPkgName() + "," + p.getClassName() + "," + p.getMethodName() + "," 
//                		+ "CHECKED," + p.getParameterSize() + "," + p.getStartPosition() + "\n";
//                
//            } else {
//            	str = p.getPkgName() + "," + p.getClassName() + "," + p.getMethodName() + "," 
//                		+ "UNCHECKED," + p.getParameterSize() + "," + p.getStartPosition() + "\n";
//            }
            return p.getPkgName();
         }
      });
